...
1. 종합소득
    - 이 법에 따라 과세되는 모든 소득에서 제 2호 및 제 3호에 따른 소득을 제외한 소득으로서 다음 각 목의 소득을 합산한 것
    - 가. 이자소득
    - 나. 배당소득
    - 다. 사업소득
    - 라. 근로소득
...
다만, 해당 과세기간 중도에 퇴직한 사람에게는 퇴직한 한 날의 다음 날 말일까지 발급하여야 하며,
일용근로자에 대하여는 근로소득의 지급일에 속하는 다음 달 말일까지 발급하여야 합니다.
